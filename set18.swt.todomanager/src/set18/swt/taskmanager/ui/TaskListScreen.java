...
import com.calc.utility.MessageDialog;
import com.calc.utility.UIBuilder;
...
public class TaskListScreen implements UIBuilder{
	...
	public void build(Composite parent) {
		...
		Table table=new Table(parent, SWT.BORDER|SWT.Selection);
		...
		for(Task task : tasks) {
			...
			tableItem.addListener(SWT.Selection, new Listener() {
	            ...
	            public void handleEvent(Event arg0) {
	               System.out.println("table item selected");
	            }
	        });
		}
